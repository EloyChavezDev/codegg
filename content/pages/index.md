  ...
  - type: grid_section
    ...
    grid_items:
      ...
      - title: Mantenimiento preventivo y correctivo
        title_align: left
        content: "En la mayoría de los casos debido a\_**no dar mantenimiento oportuno a tus computadoras**, impresoras y equipos electrónicos algún día te van a fallar por el\_**calentamiento, virus, desconfiguración**, el no actualizar programas, entre otros problemas.\n\nNosotros somos la solución a estos problemas, creamos bitácoras de mantenimiento, pólizas de mantenimiento y puedes consultar el historial de mantenimiento de tu equipo en todo momento.\n"
        content_align: left
        actions:
          - label: Saber mas
            url: /style-guide
